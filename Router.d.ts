 ...
 */
export type AsyncSvelteComponent = () => Promise<{default: Component<any>}>
...
/** List of routes */
export type RouteDefinition = Record<string, Component<any> | WrappedComponent> |
    Map<string | RegExp, Component<any> | WrappedComponent>
